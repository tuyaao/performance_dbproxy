...
public class HostClient extends AbstractClient<String> {
	...
	public static void main(String[] args) {
		...
		Timestamp createTime = new Timestamp(Calendar.getInstance()
				.getTimeInMillis());
		Timestamp updateTime = new Timestamp(Calendar.getInstance()
				.getTimeInMillis());
		BeanHostRegister beanHostRegiste = new BeanHostRegister(0,
				"210.14.158.72", "ergaergagag", 2, "jingnan_1c_2g",
				"jingnan_1c_2g", createTime, updateTime, "ACTIVE",
				"CentOS_release_6.4_(Final)", null, 1, 1, 1, null);
